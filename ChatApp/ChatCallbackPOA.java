 ...
 implements ChatApp.ChatCallbackOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("printGameArea", new java.lang.Integer (1));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // ChatApp/ChatCallback/printGameArea
       {
         char gameArea[][] = ChatApp.ChatCallbackPackage.GameAreaHelper.read (in);
         String xTeam = in.read_string ();
         String oTeam = in.read_string ();
         this.printGameArea (gameArea, xTeam, oTeam);
         out = $rh.createReply();
         break;
       }
