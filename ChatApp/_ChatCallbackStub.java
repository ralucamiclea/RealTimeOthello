...
public class _ChatCallbackStub extends org.omg.CORBA.portable.ObjectImpl implements ChatApp.ChatCallback
{
  ...
  public void printGameArea (char[][] gameArea, String xTeam, String oTeam)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("printGameArea", true);
                ChatApp.ChatCallbackPackage.GameAreaHelper.write ($out, gameArea);
                $out.write_string (xTeam);
                $out.write_string (oTeam);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                printGameArea (gameArea, xTeam, oTeam        );
            } finally {
                _releaseReply ($in);
            }
  } // printGameArea
