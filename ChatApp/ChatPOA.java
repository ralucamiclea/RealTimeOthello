 ...
 implements ChatApp.ChatOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("othelloStart", new java.lang.Integer (4));
    _methods.put ("othelloInsert", new java.lang.Integer (5));
    _methods.put ("othelloLeave", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // ChatApp/Chat/othelloStart
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         char color = in.read_char ();
         boolean $result = false;
         $result = this.othelloStart (objref, color);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }

       case 5:  // ChatApp/Chat/othelloInsert
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         int x = in.read_long ();
         int y = in.read_long ();
         this.othelloInsert (objref, x, y);
         out = $rh.createReply();
         break;
       }

       case 6:  // ChatApp/Chat/othelloLeave
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         this.othelloLeave (objref);
         out = $rh.createReply();
         break;
       }
